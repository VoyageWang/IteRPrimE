...
from util.stanza_utils import find_main_words, find_agent_by_stanza, find_no_main_words
...
class VLPModel:
    ...
    def find_no_main_words(self, sent, start_idx, tokenizer):
        return find_no_main_words(sent, start_idx, tokenizer)
