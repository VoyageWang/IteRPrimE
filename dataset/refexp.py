...
class ModulatedDetection(torchvision.datasets.CocoDetection):
    ...
    def __getitem__(self, idx):
        ...
        while not instance_check:
            ...
            target['path'] = os.path.join(self.root, coco_img['file_name'])
...
def build(dataset_file, image_set, args):
    ...
    PATHS = {
        ...
        "testA": (root / "train2014", root / dataset / f"{mode}_{dataset}_testA.json"),
        "testB": (root / "train2014", root / dataset / f"{mode}_{dataset}_testB.json"),
    }
